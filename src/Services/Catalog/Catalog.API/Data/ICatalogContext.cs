...
namespace Catalog.API.Data
{
    ...
    {
        public static void SeedData(IMongoCollection<Product> ProdCol)
        {
            bool exists = ProdCol.Find(p => true).Any();
            if (!exists)
            {
                ProdCol.InsertManyAsync(Values());
            }
        }
        private static IEnumerable<Product> Values()
        {
